...
String approval_url="http://localhost:8080/test1/approval.jsp";
String cancel_url="http://localhost:8080/test1/cancel.jsp";
String fail_url="http://localhost:8080/test1/fail.jsp";
