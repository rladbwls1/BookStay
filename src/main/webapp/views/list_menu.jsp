...
<body>
    ...
    if (cid == null || cpw == null || cauto == null) { %>
		<div><button class="btn bbtn"><a href="/BookStay/member/loginform.jsp">로그인</a></button></div>
		<div><button class="btn bbtn"><a href="/BookStay/member/memberForm.jsp">회원가입</a></button></div>
		<%}				
		}if(grade==0 || grade==99){ %>
		<div><button class="btn bbtn"><a href="/BookStay/member/logout.jsp">로그아웃</a></button></div>
		<div class="dropdown">
		  <button class="btn bbtn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
		    MyPage
		  </button>
		...
		<%if(grade==99){ %>
		<div><button class="btn bbtn"><a href="/BookStay/admin/adminMain.jsp">관리자페이지</a></button></div>
		<%} %>	
	</div>
	<div id="logo">
		<a href="main.jsp">
